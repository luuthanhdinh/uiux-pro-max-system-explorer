...
export const systemDesigns: SystemDesign[] = [
  ...
  },
  {
    id: 'travel-booking',
    name: 'Travel & Booking',
    tagline: 'Wanderlust-driven travel platform with smart search and seamless booking',
    productType: 'Travel / OTA',
    style: 'Immersive Editorial',
    styleSecondary: 'Glassmorphism',
    colors: {
      primary: '#0EA5E9',
      secondary: '#38BDF8',
    ...
    typography: {
      headingFont: 'Sora',
      bodyFont: 'Inter',
      cssImport: "@import url('https://fonts.googleapis.com/css2?family=Sora:wght@400;500;600;700;800&family=Inter:wght@300;400;500;600&display=swap');",
      googleFontsUrl: 'https://fonts.google.com/share?selection.family=Sora:wght@400;500;600;700;800|Inter:wght@300;400;500;600',
    },
    pages: [
      { id: 'landing', label: 'Landing', description: 'Hero with destination search and trending places' },
      { id: 'search', label: 'Search', description: 'Flight and hotel search results with filters' },
      { id: 'detail', label: 'Detail', description: 'Hotel/flight detail with photos and booking CTA' },
      { id: 'checkout', label: 'Checkout', description: 'Booking confirmation with traveler details' },
    ],
    mood: 'light',
    tags: ['Travel', 'Booking', 'OTA', 'Immersive', 'Clean'],
  },
  {
    id: 'hr-people',
    name: 'HR & People Ops',
    tagline: 'Modern HR platform for teams — hiring, onboarding, and performance in one place',
    productType: 'HR / People Operations',
    style: 'Soft UI',
    styleSecondary: 'Minimalism',
    colors: {
      primary: '#6366F1',
    ...
    typography: {
      ...
      bodyFont: 'Inter',
      cssImport: "@import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&family=Inter:wght@300;400;500;600&display=swap');",
      googleFontsUrl: 'https://fonts.google.com/share?selection.family=Plus+Jakarta+Sans:wght@400;500;600;700;800|Inter:wght@300;400;500;600',
    },
    pages: [
      { id: 'dashboard', label: 'Dashboard', description: 'People overview — headcount, hiring, org health' },
      { id: 'candidates', label: 'Candidates', description: 'ATS pipeline with kanban stage view' },
      { id: 'employee', label: 'Employee', description: 'Individual profile with goals and performance' },
      { id: 'onboarding', label: 'Onboarding', description: 'New hire checklist and day-one task tracker' },
    ],
    mood: 'light',
    tags: ['HR', 'People Ops', 'B2B', 'SaaS', 'Soft UI'],
  },
  {
    id: 'nft-marketplace',
    name: 'NFT Marketplace',
    tagline: 'Web3-native NFT marketplace with wallet connect and live auction system',
    productType: 'Web3 / NFT',
    style: 'Dark Neon',
    styleSecondary: 'Glassmorphism',
    colors: {
      primary: '#A855F7',
    ...
    typography: {
      headingFont: 'Outfit',
      bodyFont: 'Inter',
      cssImport: "@import url('https://fonts.googleapis.com/css2?family=Outfit:wght@400;500;600;700;800&family=Inter:wght@300;400;500;600&display=swap');",
      googleFontsUrl: 'https://fonts.google.com/share?selection.family=Outfit:wght@400;500;600;700;800|Inter:wght@300;400;500;600',
    },
    pages: [
      { id: 'landing', label: 'Landing', description: 'Hero with featured drops and trending collections' },
      { id: 'explore', label: 'Explore', description: 'NFT grid with category filters and sort' },
      { id: 'item', label: 'NFT Detail', description: 'Item view with bid history and buy now' },
      { id: 'profile', label: 'Creator Profile', description: 'Wallet stats, created and collected items' },
    ],
    mood: 'dark',
    tags: ['Web3', 'NFT', 'Crypto', 'Dark', 'Neon'],
  },
  {
    id: 'fitness-app',
    name: 'Fitness & Wellness',
    tagline: 'Energy-packed fitness app with workout plans, tracking, and nutrition logging',
    productType: 'Fitness / Wellness',
    style: 'Energetic Bold',
    styleSecondary: 'Dark Mode',
    colors: {
      primary: '#F97316',
      secondary: '#FB923C',
      cta: '#22C55E',
    ...
    typography: {
      ...
      bodyFont: 'Inter',
      cssImport: "@import url('https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@400;500;600;700;800&family=Inter:wght@300;400;500;600&display=swap');",
      googleFontsUrl: 'https://fonts.google.com/share?selection.family=Barlow+Condensed:wght@400;500;600;700;800|Inter:wght@300;400;500;600',
    },
    pages: [
      { id: 'dashboard', label: 'Dashboard', description: 'Daily rings, streak, and upcoming workout' },
      { id: 'workout', label: 'Workout', description: 'Active workout timer with exercise steps' },
      { id: 'plans', label: 'Plans', description: 'Browse and start training programs' },
      { id: 'nutrition', label: 'Nutrition', description: 'Calorie tracker and macro breakdown' },
    ],
    mood: 'dark',
    tags: ['Fitness', 'Health', 'Dark', 'Bold', 'Mobile'],
  },
];
